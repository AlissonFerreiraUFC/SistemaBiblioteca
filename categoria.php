...
//{
	if(isset($_POST['submit']))
	{
		...
		$result = MySQLI_query($conexao, "INSERT INTO categorias(id_categoria,descricao)VALUES ('$id_categoria','$descricao')");
	}
?>
<html>
    <head> 
...
<body>
   ...
   <br>
		    <div class= "inputBox">
			<input type="number" name="id_categoria" id="id_categoria" class="inputUser" required>
